...
public class UiOfLoginPageForHindi extends BaseClass
{ 
    ...
    public void selectHindi() {
    	...
    	// ✅ Select Hindi by visible text
    	select.selectByVisibleText("हिंदी");

    	// Verify Hindi is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "हिंदी", "❌ Failed to select 'हिंदी' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "साइन इन करें", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "उपयोगकर्ता नाम/ईमेल/ मोबाइल", "Placeholder text does not match expected.");
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "याद रखना", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "आगे जाये", "Label text is not matching!");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "सुरक्षित लॉगिन के माध्यम से", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "ऐप", "Label text is not matching!");
