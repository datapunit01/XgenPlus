...
//
//public class UiOfLoginPageforTelugu extends BaseClass
//{ 
//      
//    @Test(priority = 1)
...
//    	Select select = new Select(langDropdown);
//
//    	// ✅ Select Telugu by visible text
//    	select.selectByVisibleText("తెలుగు");
//
//    	// Verify Telugu is selected
//    	String selectedText = select.getFirstSelectedOption().getText();
//    	Assert.assertEquals(selectedText, "తెలుగు", "❌ Failed to select 'తెలుగు' from dropdown.");
...
//        Assert.assertEquals(labelText, "సైన్ ఇన్ చేయండి", "Label text is not matching!");
//    }
//
//    @Test(priority = 5)
...
//        Assert.assertEquals(plcHolder, "యూజర్ పేరు/ఇమెయిల్/మొబైల్", "Placeholder text does not match expected.");
//
...
//        Assert.assertEquals(labelText, "నన్ను గుర్తు పెట్టుకో", "Label text is not matching!");
//    }
//
//    @Test(priority = 8)
...
//        
//        Assert.assertEquals(labelText, "తరువాత", "Label text is not matching!");
//        
//        nxtbtn.click();
//        Thread.sleep(2000);
...
//        Assert.assertEquals(labelText, "ద్వారా సురక్షిత లాగిన్", "Label text is not matching!");
//
//        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
//        String labelText2 = app.getText();
//	    Assert.assertEquals(labelText2, "అప్", "Label text is not matching!");
//       
//        
//        app.click();
//        
