...
//
//public class UiOfLoginPageForKazakh extends BaseClass
//{ 
//      
//    @Test(priority = 1)
...
//    	Select select = new Select(langDropdown);
//
//    	// ✅ Select ҚАЗАҚ by visible text
//    	select.selectByVisibleText("ҚАЗАҚ");
//
//    	// Verify ҚАЗАҚ is selected
//    	String selectedText = select.getFirstSelectedOption().getText();
//    	Assert.assertEquals(selectedText, "ҚАЗАҚ", "❌ Failed to select 'ҚАЗАҚ' from dropdown.");
...
//        Assert.assertEquals(labelText, "Кіру", "Label text is not matching!");
//    }
//
//    @Test(priority = 5)
...
//        Assert.assertEquals(plcHolder, "Пайдаланушы аты/Электрондық пошта/Ұялы", "Placeholder text does not match expected.");
//
...
//    	   
//
//    	    // Wait for and click Forgot Email link
//    	    WebElement forgot = wait.until(ExpectedConditions
//    	            .visibilityOfElementLocated(By.xpath("//a[@id='foorgetEmail']")));
//    	    String labelText= forgot.getText();
//    	    Assert.assertEquals(labelText, "Электрондық поштаны ұмыттыңыз ба?", "Label text is not matching!");
//    	    forgot.click();
//    	    
//    	    // Wait for Forgot Page heading
//    	    WebElement forgotPage = wait.until(ExpectedConditions
//    	            .visibilityOfElementLocated(By.xpath("//h4[@id='findEmailAdd']")));
//    	    String labelText2 = forgotPage.getText();
//    	    Assert.assertEquals(labelText2, "Электрондық пошта мекенжайыңызды табыңыз", "Label text is not matching!");
//    	    Thread.sleep(2000);
//
//    	    // 🔙 Click Cancel to go back to Login Page
//    	    WebElement cancelBtn = wait.until(ExpectedConditions
//    	            .elementToBeClickable(By.id("mobileCancel")));
//    	    cancelBtn.click();
//
...
//        Assert.assertEquals(labelText, "Мені есте сақтау", "Label text is not matching!");
//    }
//
//    @Test(priority = 8)
...
//        
//        Assert.assertEquals(labelText, "Келесі", "Label text is not matching!");
//        
//        nxtbtn.click();
//        Thread.sleep(2000);
...
//        Assert.assertEquals(labelText, "арқылы қауіпсіз кіру", "Label text is not matching!");
//
//        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
//        String labelText2 = app.getText();
//	    Assert.assertEquals(labelText2, "ҚОСЫМША", "Label text is not matching!");
//       
//        
//        app.click();
//        
...
//	           .visibilityOfElementLocated(By.xpath("//h1[contains(text(),'XGENPLUS құпиялылық саясатына қош келдіңіз')]")));
...
//	           .visibilityOfElementLocated(By.xpath("//h1[contains(text(),'XgenPlus пайдалану шарттары')]")));
