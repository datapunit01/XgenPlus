...
//
//public class UiOfLoginPageForGujarati extends BaseClass
//{ 
//      
//    @Test(priority = 1)
...
//    	Select select = new Select(langDropdown);
//
//    	// ✅ Select Gujarati by visible text
//    	select.selectByVisibleText("ગુજરાતી");
//
//    	// Verify Gujarati is selected
//    	String selectedText = select.getFirstSelectedOption().getText();
//    	Assert.assertEquals(selectedText, "ગુજરાતી", "❌ Failed to select 'ગુજરાતી' from dropdown.");
...
//        Assert.assertEquals(labelText, "સાઇન ઇન કરો", "Label text is not matching!");
//    }
//
//    @Test(priority = 5)
...
//        Assert.assertEquals(plcHolder, "વપરાશકર્તા નામ/ઈમેલ/મોબાઇલ", "Placeholder text does not match expected.");
//
...
//        Assert.assertEquals(labelText, "મને યાદ", "Label text is not matching!");
//    }
//
//    @Test(priority = 8)
...
//        Assert.assertEquals(labelText, "સુરક્ષિત લૉગિન મારફતે", "Label text is not matching!");
//
//        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
//        String labelText2 = app.getText();
//	    Assert.assertEquals(labelText2, "અપ્પ", "Label text is not matching!");
//       
//        
//        app.click();
//        
