...
public class UiOfLoginPafeForMarathi extends BaseClass
{ 
    ...
    public void selectHindi() {
    	...
    	// ✅ Select मराठी by visible text
    	select.selectByVisibleText("मराठी");

    	// Verify मराठी is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "मराठी", "❌ Failed to select 'मराठी' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "साइन इन करा", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "वापरकर्तानाव/ईमेल/मोबाइल", "Placeholder text does not match expected.");
    ...
    public void forgotEmailCancelButton() throws InterruptedException 
    {
    	    ...
    	    Assert.assertEquals(labelText, "ईमेल विसरलात?", "Label text is not matching!");
    	    forgot.click();
    	    ...
    	    Assert.assertEquals(labelText2, "तुमचा ईमेल पत्ता शोधा", "Label text is not matching!");
    	    Thread.sleep(2000);
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "मला लक्षात ठेवा", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "पुढे", "Label text is not matching!");
     ...
     // Wait for Password Page heading
	    ...
	    Assert.assertEquals(labelText2,"पासवर्ड टाका", "Label text 2 is not matching!");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "सुरक्षित लॉगिन मार्गे", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "ॲप", "Label text is not matching!");
