...
public class UiOfLoginPageForQazaqlatin extends BaseClass
{ 
    ...
    public void selectHindi() {
    	...
    	// ✅ Select qazaq latin by visible text
    	select.selectByVisibleText("qazaq latin");

    	// Verify qazaq latin is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "qazaq latin", "❌ Failed to select 'qazaq latin' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "Jüyege kiru", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "Atalsym/Elektrondy poshta/Telefon", "Placeholder text does not match expected.");
    ...
    public void forgotEmailCancelButton() throws InterruptedException 
    {
    	    ...
    	    Assert.assertEquals(labelText, "Elektrondy poshtańyzdy umyttyńyz ba?", "Label text is not matching!");
    	    forgot.click();
    	    ...
    	    Assert.assertEquals(labelText2, "Elektrondy poshta mekenjaıyńyzdy tabyńyz", "Label text is not matching!");
    	    Thread.sleep(2000);
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "Meni este saqtańyz", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "Kelesi", "Label text is not matching!");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "Qaýipsiz kiru arqyly", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "Qosymsha", "Label text is not matching!");
