...
public class UiOfLoginPageforTamil extends BaseClass
{ 
    ...
    public void selectTamil() {
    	...
    	// ✅ Select Tamil by visible text
    	select.selectByVisibleText("தமிழ்");

    	// Verify Tamil is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "தமிழ்", "❌ Failed to select 'தமிழ்' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "உள்நுழையவும்", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "பயனர்பெயர்/மின்னஞ்சல்/மொபைல்", "Placeholder text does not match expected.");
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "என்னை நினைவில்", "Label text is not matching!");
    }
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "பாதுகாப்பான உள்நுழைவு வழியாக", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "ஆப்", "Label text is not matching!");
