...
//
//public class UiOfLoginPageForSantali extends BaseClass
//{ 
//      
//    @Test(priority = 1)
...
//    	Select select = new Select(langDropdown);
//
//    	// ✅ Select ᱥᱟᱱᱛᱷᱟᱲᱤ by visible text
//    	select.selectByVisibleText("ᱥᱟᱱᱛᱷᱟᱲᱤ");
//
//    	// Verify ᱥᱟᱱᱛᱷᱟᱲᱤ is selected
//    	String selectedText = select.getFirstSelectedOption().getText();
//    	Assert.assertEquals(selectedText, "ᱥᱟᱱᱛᱷᱟᱲᱤ", "❌ Failed to select 'ᱥᱟᱱᱛᱷᱟᱲᱤ' from dropdown.");
...
//        Assert.assertEquals(labelText, "ᱥᱟᱭᱤᱱ ᱤᱱ", "Label text is not matching!");
//    }
//
//    @Test(priority = 5)
...
//        Assert.assertEquals(plcHolder, "ᱵᱮᱵᱷᱟᱨᱤᱭᱟᱹ ᱧᱩᱛᱩᱢ/ᱤᱢᱮᱞ/ᱢᱚᱵᱟᱭᱤᱞ", "Placeholder text does not match expected.");
//
...
//        Assert.assertEquals(labelText, "ᱫᱤᱥᱟᱹ ᱫᱚᱦᱚᱭᱤᱧ ᱢᱮ", "Label text is not matching!");
//    }
//
//    @Test(priority = 8)
...
//        
//        Assert.assertEquals(labelText, "ᱛᱟᱭᱚᱢ", "Label text is not matching!");
//        
//        nxtbtn.click();
//        Thread.sleep(2000);
...
//	    Assert.assertEquals(passwordPage,"ᱫᱟᱥᱣᱟᱨᱰ ᱮᱢ ᱢᱮ", "Label text 2 is not matching!");
//	    
//
...
//        Assert.assertEquals(labelText, "ᱨᱟᱠᱷᱟ ᱞᱚᱜᱤᱱ ᱦᱚᱛᱮᱛᱮ", "Label text is not matching!");
//
//        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
//        String labelText2 = app.getText();
//	    Assert.assertEquals(labelText2, "ᱮᱯᱤᱯᱤ", "Label text is not matching!");
//       
//        
//        app.click();
//        
