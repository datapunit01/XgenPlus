...
//
//public class UiOfLoginPageForSanskrit extends BaseClass
//{ 
//      
//    @Test(priority = 1)
...
//    	Select select = new Select(langDropdown);
//
//    	// ✅ Select संस्कृत by visible text
//    	select.selectByVisibleText("संस्कृत");
//
//    	// Verify संस्कृत is selected
//    	String selectedText = select.getFirstSelectedOption().getText();
//    	Assert.assertEquals(selectedText, "संस्कृत", "❌ Failed to select 'संस्कृत' from dropdown.");
...
//        Assert.assertEquals(labelText, "साइन-इन करोतु।", "Label text is not matching!");
//    }
//
//    @Test(priority = 5)
...
//        Assert.assertEquals(plcHolder, "उपयोक्तृनाम/इमेल/दूरभाषाङ्कः", "Placeholder text does not match expected.");
//
...
//        Assert.assertEquals(labelText, "स्मरतु", "Label text is not matching!");
//    }
//
//    @Test(priority = 8)
...
//        
//        Assert.assertEquals(labelText, "अग्रिम", "Label text is not matching!");
//        
//        nxtbtn.click();
//        Thread.sleep(2000);
...
//	    Assert.assertEquals(labelText2,"गुह्यशब्दं लिखतु", "Label text 2 is not matching!");
//	    
//
...
//        Assert.assertEquals(labelText, "सुरक्षित-प्रवेशः", "Label text is not matching!");
//
//        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
//        String labelText2 = app.getText();
//	    Assert.assertEquals(labelText2, "अनुप्रयोगः", "Label text is not matching!");
//       
//        
//        app.click();
//        
