...
public class UiOfLoginPageForJapanese extends BaseClass
{ 
    ...
    public void selectHindi() {
    	...
    	// ✅ Select 日本人 by visible text
    	select.selectByVisibleText("日本人");

    	// Verify 日本人 is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "日本人", "❌ Failed to select '日本人' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "ログイン", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "ユーザー名/メール/モバイル", "Placeholder text does not match expected.");
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "私を覚えてますか", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "次へ", "Label text is not matching!");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "経由で安全にログイン", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "アプリ", "Label text is not matching!");
