...
public class UiOfLoginPageForPunjabi extends BaseClass
{ 
    ...
    public void selectPunjabi() {
    	...
    	// ✅ Select Punjabi by visible text
    	select.selectByVisibleText("ਪੰਜਾਬੀ");

    	// Verify Punjabi is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "ਪੰਜਾਬੀ", "❌ Failed to select 'ਪੰਜਾਬੀ' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "ਸਾਈਨ - ਇਨ", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "ਉਪਭੋਗੀ/ਈ - ਮੇਲ/ਮੋਬਾਈਲ", "Placeholder text does not match expected.");
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "ਮੈਨੂੰ ਯਾਦ ਰੱਖੋ", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        String labelText = nxtbtn.getText();
        
        Assert.assertEquals(labelText, "ਅਗਲਾ", "Label text is not matching!");
     ...
     // Wait for Password Page heading
        ...
        String plcHolder = textBox.getAttribute("placeholder");
        Assert.assertEquals(plcHolder, "ব্যবহারকারীর নাম/ইমেইল/মোবাইল", "Placeholder text does not match expected.");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "ਸੁਰੱਖਿਅਤ ਲੌਗਇਨ ਰਾਹੀਂ", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "ਅੱਪ", "Label text is not matching!");
