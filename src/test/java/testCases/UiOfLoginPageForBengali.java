...
public class UiOfLoginPageForBengali extends BaseClass
{ 
    ...
    public void selectBengali() {
    	...
    	// ✅ Select Bengali by visible text
    	select.selectByVisibleText("বাঙালি");

    	// Verify Bengali is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "বাঙালি", "❌ Failed to select 'বাঙালি' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "সাইন ইন করুন", "Label text is not matching!");
    }
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "আমাকে মনে কর", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "পরবর্তী", "Label text is not matching!");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "এর মাধ্যমে নিরাপদ লগইন করুন", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "আপা", "Label text is not matching!");
