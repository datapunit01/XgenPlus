...
public class UiOfLoginPageForOdia extends BaseClass
{ 
    ...
    public void selectHindi() {
    	...
    	// ✅ Select Odia by visible text
    	select.selectByVisibleText("ଓଡିଆ");

    	// Verify Odia is selected
    	String selectedText = select.getFirstSelectedOption().getText();
    	Assert.assertEquals(selectedText, "ଓଡିଆ", "❌ Failed to select 'ଓଡିଆ' from dropdown.");
    ...
    public void signIn() 
    {
        ...
        Assert.assertEquals(labelText, "ସାଇନ୍ ଇନ୍ କରନ୍ତୁ", "Label text is not matching!");
    }
    ...
    public void inputBox() 
    {
        ...
        Assert.assertEquals(plcHolder, "ଉପଯୋଗକର୍ତ୍ତା ନାମ/ଇମେଲ/ମୋବାଇଲ", "Placeholder text does not match expected.");
    ...
    public void toggleButton() throws InterruptedException 
    {
     ...
     // Assert that the disabled toggle button is actually enabled
      ...
      //  Thread.sleep(2000);
        ...
        Assert.assertEquals(labelText, "ମନେ ରଖନ୍ତୁ", "Label text is not matching!");
    }
    ...
    public void nextBtnBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "ଆଗକୁ ଯାଆନ୍ତୁ", "Label text is not matching!");
     ...
     // Wait for Password Page heading
	    ...
	    Assert.assertEquals(passwordPage,"ପାସୱାର୍ଡ ପ୍ରବେଶ କରନ୍ତୁ", "Label text 2 is not matching!");
    ...
    public void secureLoginBackBtn() throws InterruptedException 
    {
        ...
        Assert.assertEquals(labelText, "ସୁରକ୍ଷିତ ଲଗଇନ୍ ମାଧ୍ୟମରେ", "Label text is not matching!");

        WebElement app = driver.findElement(By.xpath("//a[@id='loginVia_App']"));
        String labelText2 = app.getText();
	    Assert.assertEquals(labelText2, "ଆପ୍", "Label text is not matching!");
