...
public class ComposeWithDraftPage extends BasePage {
	...
	public ComposeWithDraftPage(ThreadLocal<WebDriver> driver) throws IOException {
		super(driver.get());
	...
	//	ruse.onComposeSubjectText.sendKeys(textforMailSubject);		
		...
		// --- Final Send ---
		ruse.isComposeCrossBtnDisplayedRe();
		ruse.clickOnComposeCrossBtnRe();
		log.info(" On compose Page Cross Button is displayed and clicked. ");
		
	}
	
	public void verifyMailFromDraftBox(String mailSubjectText,String nameOfInlineImage) throws InterruptedException, IOException {
		log.info("Verifying Draft mail in Draft Box with subject: {}", mailSubjectText);
		ruse.verifyMailInDraftBoxRe(mailSubjectText,nameOfInlineImage);		
		log.info(" Compose's Inline Image Successfully verified from Draft folder. ");
		clickSendBtn();
	...
	public void verifyMailFromSentBoxAfterDraft(String mailSubjectText,String nameOfInlineImage) throws InterruptedException, IOException {
